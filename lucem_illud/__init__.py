...
_setupURL = 'https://raw.githubusercontent.com/UChicago-Computational-Content-Analysis/lucem_illud/master/setup.py'
...
def _checkCurrentVersion():
    ...
    if serverVersion != serverVersion:
        ...
        print('pip install -U git+git://github.com/UChicago-Computational-Content-Analysis/lucem_illud.git')
